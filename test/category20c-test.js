...
tape("category20c() is an ordinal scale", function(test) {
  var s = scale.category20c();
...
tape("category20c() returns an isolated instance", function(test) {
  var s1 = scale.category20c(),
      s2 = scale.category20c();
