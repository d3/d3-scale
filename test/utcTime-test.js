...
tape("utcTime.nice() is an alias for utcTime.nice(10)", function(test) {
  var x = scale.utcTime().domain([date.utc(2009, 0, 1, 0, 17), date.utc(2009, 0, 1, 23, 42)]);
  test.deepEqual(x.nice().domain(), [date.utc(2009, 0, 1), date.utc(2009, 0, 2)]);
  test.end();
});

tape("utcTime.nice() can nice sub-second domains", function(test) {
  var x = scale.utcTime().domain([date.utc(2013, 0, 1, 12, 0, 0, 0), date.utc(2013, 0, 1, 12, 0, 0, 128)]);
  test.deepEqual(x.nice().domain(), [date.utc(2013, 0, 1, 12, 0, 0, 0), date.utc(2013, 0, 1, 12, 0, 0, 130)]);
  test.end();
});

tape("utcTime.nice() can nice multi-year domains", function(test) {
  var x = scale.utcTime().domain([date.utc(2001, 0, 1), date.utc(2138, 0, 1)]);
  test.deepEqual(x.nice().domain(), [date.utc(2000, 0, 1), date.utc(2140, 0, 1)]);
  test.end();
});

tape("utcTime.nice() can nice empty domains", function(test) {
...
tape("utcTime.nice(count) nices using the specified tick count", function(test) {
  var x = scale.utcTime().domain([date.utc(2009, 0, 1, 0, 17), date.utc(2009, 0, 1, 23, 42)]);
...
tape("utcTime.copy() isolates changes to the domain", function(test) {
  var x = scale.utcTime().domain([date.utc(2009, 0, 1), date.utc(2010, 0, 1)]), y = x.copy();
...
tape("utcTime.copy() isolates changes to the range", function(test) {
  var x = scale.utcTime().domain([date.utc(2009, 0, 1), date.utc(2010, 0, 1)]), y = x.copy();
  x.range([1, 2]);
...
tape("utcTime.copy() isolates changes to the interpolator", function(test) {
...
tape("utcTime.copy() isolates changes to clamping", function(test) {
  var x = scale.utcTime().domain([date.utc(2009, 0, 1), date.utc(2010, 0, 1)]).clamp(true), y = x.copy();
  x.clamp(false);
...
tape("utcTime.ticks(count) can generate sub-second ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2011, 0, 1, 12, 0, 0), date.utc(2011, 0, 1, 12, 0, 1)]);
...
tape("utcTime.ticks(count) can generate 1-second ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2011, 0, 1, 12, 0, 0), date.utc(2011, 0, 1, 12, 0, 4)]);
  test.deepEqual(x.ticks(4), [
...
tape("utcTime.ticks(count) can generate 5-second ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2011, 0, 1, 12, 0, 0), date.utc(2011, 0, 1, 12, 0, 20)]);
  test.deepEqual(x.ticks(4), [
    date.utc(2011, 0, 1, 12, 0, 0),
...
tape("utcTime.ticks(count) can generate 15-second ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2011, 0, 1, 12, 0, 0), date.utc(2011, 0, 1, 12, 0, 50)]);
  test.deepEqual(x.ticks(4), [
    date.utc(2011, 0, 1, 12, 0, 0),
    date.utc(2011, 0, 1, 12, 0, 15),
...
tape("utcTime.ticks(count) can generate 30-second ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2011, 0, 1, 12, 0, 0), date.utc(2011, 0, 1, 12, 1, 50)]);
  test.deepEqual(x.ticks(4), [
    date.utc(2011, 0, 1, 12, 0, 0),
    date.utc(2011, 0, 1, 12, 0, 30),
...
tape("utcTime.ticks(count) can generate 1-minute ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2011, 0, 1, 12, 0, 27), date.utc(2011, 0, 1, 12, 4, 12)]);
  test.deepEqual(x.ticks(4), [
    date.utc(2011, 0, 1, 12, 1),
    date.utc(2011, 0, 1, 12, 2),
    date.utc(2011, 0, 1, 12, 3),
...
tape("utcTime.ticks(count) can generate 5-minute ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2011, 0, 1, 12, 3, 27), date.utc(2011, 0, 1, 12, 21, 12)]);
  test.deepEqual(x.ticks(4), [
...
tape("utcTime.ticks(count) can generate 15-minute ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2011, 0, 1, 12, 8, 27), date.utc(2011, 0, 1, 13, 4, 12)]);
  test.deepEqual(x.ticks(4), [
    date.utc(2011, 0, 1, 12, 15),
    date.utc(2011, 0, 1, 12, 30),
...
tape("utcTime.ticks(count) can generate 30-minute ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2011, 0, 1, 12, 28, 27), date.utc(2011, 0, 1, 14, 4, 12)]);
  test.deepEqual(x.ticks(4), [
    date.utc(2011, 0, 1, 12, 30),
    date.utc(2011, 0, 1, 13, 0),
...
tape("utcTime.ticks(count) can generate 1-hour ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2011, 0, 1, 12, 28, 27), date.utc(2011, 0, 1, 16, 34, 12)]);
  test.deepEqual(x.ticks(4), [
    date.utc(2011, 0, 1, 13, 0),
    date.utc(2011, 0, 1, 14, 0),
...
tape("utcTime.ticks(count) can generate 3-hour ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2011, 0, 1, 14, 28, 27), date.utc(2011, 0, 2, 1, 34, 12)]);
  test.deepEqual(x.ticks(4), [
    date.utc(2011, 0, 1, 15, 0),
...
tape("utcTime.ticks(count) can generate 6-hour ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2011, 0, 1, 16, 28, 27), date.utc(2011, 0, 2, 14, 34, 12)]);
  test.deepEqual(x.ticks(4), [
    date.utc(2011, 0, 1, 18, 0),
    date.utc(2011, 0, 2, 0, 0),
...
tape("utcTime.ticks(count) can generate 12-hour ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2011, 0, 1, 16, 28, 27), date.utc(2011, 0, 3, 21, 34, 12)]);
  test.deepEqual(x.ticks(4), [
    date.utc(2011, 0, 2, 0, 0),
    date.utc(2011, 0, 2, 12, 0),
...
tape("utcTime.ticks(count) can generate 1-day ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2011, 0, 1, 16, 28, 27), date.utc(2011, 0, 5, 21, 34, 12)]);
  test.deepEqual(x.ticks(4), [
    date.utc(2011, 0, 2, 0, 0),
    date.utc(2011, 0, 3, 0, 0),
...
tape("utcTime.ticks(count) can generate 2-day ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2011, 0, 2, 16, 28, 27), date.utc(2011, 0, 9, 21, 34, 12)]);
  test.deepEqual(x.ticks(4), [
    date.utc(2011, 0, 3, 0, 0),
    date.utc(2011, 0, 5, 0, 0),
...
tape("utcTime.ticks(count) can generate 1-week ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2011, 0, 1, 16, 28, 27), date.utc(2011, 0, 23, 21, 34, 12)]);
  test.deepEqual(x.ticks(4), [
    date.utc(2011, 0, 2, 0, 0),
    date.utc(2011, 0, 9, 0, 0),
...
tape("utcTime.ticks(count) can generate 1-month ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2011, 0, 18), date.utc(2011, 4, 2)]);
  test.deepEqual(x.ticks(4), [
...
tape("utcTime.ticks(count) can generate 3-month ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2010, 11, 18), date.utc(2011, 10, 2)]);
  test.deepEqual(x.ticks(4), [
...
tape("utcTime.ticks(count) can generate 1-year ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(2010, 11, 18), date.utc(2014, 2, 2)]);
  test.deepEqual(x.ticks(4), [
    date.utc(2011, 0, 1, 0, 0),
...
tape("utcTime.ticks(count) can generate multi-year ticks", function(test) {
  var x = scale.utcTime().domain([date.utc(0, 11, 18), date.utc(2014, 2, 2)]);
...
tape("utcTime.ticks(count) returns no ticks for an empty domain", function(test) {
  var x = scale.utcTime().domain([date.utc(2014, 2, 2), date.utc(2014, 2, 2)]);
  test.deepEqual(x.ticks(6), []);
  test.end();
});

tape("utcTime.tickFormat()(date) formats year on New Year's", function(test) {
  var f = scale.utcTime().tickFormat();
...
tape("utcTime.tickFormat()(date) formats month on the 1st of each month", function(test) {
  var f = scale.utcTime().tickFormat();
...
tape("utcTime.tickFormat()(date) formats week on Sunday midnight", function(test) {
  var f = scale.utcTime().tickFormat();
...
tape("utcTime.tickFormat()(date) formats date on midnight", function(test) {
  var f = scale.utcTime().tickFormat();
...
tape("utcTime.tickFormat()(date) formats hour on minute zero", function(test) {
  var f = scale.utcTime().tickFormat();
...
tape("utcTime.tickFormat()(date) formats minute on second zero", function(test) {
  var f = scale.utcTime().tickFormat();
...
tape("utcTime.tickFormat()(date) otherwise, formats second", function(test) {
  var f = scale.utcTime().tickFormat();
...
tape("utcTime.tickFormat(specifier) returns a time format for the specified specifier", function(test) {
  var f = scale.utcTime().tickFormat("%c");
