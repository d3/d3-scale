...
tape("rainbow() has the expected defaults", function(test) {
  var s = scale.rainbow();
...
tape("rainbow.clamp(true) enables clamping", function(test) {
  var s = scale.rainbow().clamp(true);
...
tape("rainbow.domain() coerces domain values to numbers", function(test) {
  var s = scale.rainbow().domain(["-1.20", "2.40"]);
